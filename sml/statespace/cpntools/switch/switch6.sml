...
use (ogpath^"cpntools/OGUtils.sml"); 
if (CPN'Time.name = "unit")
then
    use (ogpath^"cpntools/OGNodeSel.sml")
else
    use (ogpath^"cpntools/OGTimeNodeSel.sml");
...
use (ogpath^"cpntools/OGPrintFuns.sml");
use (ogpath^"cpntools/OGSetAttrOptions.sml");

use (ogpath^"cpntools/OGInOutPath.sml");
CPN'Env.use_string(CPN'OGBindGen.gen_BindStruct());
CPN'Env.use_string(CPN'OGBindGen.gen_ArcToBE());
use (ogpath^"cpntools/OGBindMap.sml");
