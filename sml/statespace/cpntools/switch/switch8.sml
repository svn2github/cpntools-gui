...
use (ogpath^"cpntools/OGGenFilters.sml");
...
CPN'Env.use_string(["val _ = ", NodeFilterGen()]);
CPN'Env.use_string(["val _ = ", ArcFilterGen()]);
use (ogpath^"cpntools/OGCalcSucc.sml"); 
use (ogpath^"cpntools/OGProps.sml");
use (ogpath^"cpntools/OGNewSaveReport.sml");
use (ogpath^"cpntools/export/OGtoGraphviz.sml");
